          ...
          <div class="steps_1" v-show="current == 0">
            ...
            <div class="flex_space-between steps_1_list">
              ...
              <Upload
                ...
                name='a'
                action="https://demo.app.jfii.vip/server/data/user/upload/idcarda">
            ...
            <div class="flex_space-between steps_1_list" style="margin-top:11px">
              ...
              <Upload
                ...
                :show-upload-list='false'
                name='b'
                action="https://demo.app.jfii.vip/server/data/user/upload/idcardb">
          ...
          <div class="steps_1" v-show="current == 1" style="height:360px">
            ...
            <div class="flex_space-between steps_1_list">
              ...
              <Upload
                ...
                :show-upload-list='false'
                name='card'
                action="https://demo.app.jfii.vip/server/data/user/bank/upload/bankcard">
